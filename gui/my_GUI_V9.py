...
class MainWindow(QMainWindow):
    def __init__(self, parent=None):
        ...
        # Variables to change
        explainationText = "This GUI allows you to load a file and display the results with different methods."
        number_methods = 4
        ...
        self.setWindowTitle("Display results")

        # How the main window is organized
        self.explainationBox = QLabel()
        self.directorySelectionBox = QHBoxLayout()
        self.displaySelectionBox = QHBoxLayout()
        self.resultDisplayBox = QHBoxLayout()

        # Alignment
        self.directorySelectionBox.setAlignment(Qt.AlignLeft)
        self.displaySelectionBox.setAlignment(Qt.AlignLeft)
        ...
        #self.select_button.clicked.connect(self.getFile)
        ...
        self.displaySelectionBox.addWidget(self.label_output)
        self.displaySelectionBox.addWidget(self.combobox_output)
        ...
        self.displaySelectionBox.addWidget(self.label_axis)
        self.displaySelectionBox.addWidget(self.combobox_axis)
        ...
        for i in range(number_methods):
            ...
            loaded_plot.setMinimumHeight(300)
            loaded_plot.setMinimumWidth(300)
            layout_plot.addWidget(loaded_plot)
            self.resultDisplayBox.addLayout(layout_plot)

        # Put everything in the mainBox
        self.mainBox.addWidget(self.explainationBox)
        self.mainBox.addLayout(self.directorySelectionBox)
        self.mainBox.addLayout(self.displaySelectionBox)
        self.mainBox.addLayout(self.resultDisplayBox)
...
if __name__ == '__main__':
    #if(path.exists(args.image) == False):
